...
- [v2.10.0](https://github.com/vivliostyle/vivliostyle.js/blob/master/CHANGELOG.md#2100-2021-09-17)
    ...
    - [white-space: break-spaces](https://developer.mozilla.org/en-US/docs/Web/CSS/white-space)……Defines the handling of whitespace in strings within an element, similar to `white-space: pre-wrap`, but also breaks lines between consecutive whitespaces.
    - [font-variant-caps](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-caps)……Controls uppercase related glyphs in Latin fonts in OpenType format.
    ...
    - [unicode-range](https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/unicode-range)…… Specifies a specific code point in the font defined by `@font-face`.
