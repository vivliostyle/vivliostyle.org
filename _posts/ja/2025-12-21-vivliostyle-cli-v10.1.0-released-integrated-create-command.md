...
v10.0では、この**`create-book`の機能がVivliostyle CLI本体に完全に統合されました。**
...
中核となるレンダリングエンジン`Vivliostyle.js`がv2.38.0に更新され、CSSの`initial-letter`プロパティがサポートされました。これにより、段落の先頭文字を大きくして複数行にまたがらせる「ドロップキャップ」表現が可能になり、雑誌や書籍のようなリッチなデザインが実現できます。
* **Node.jsサポートバージョンの更新**
