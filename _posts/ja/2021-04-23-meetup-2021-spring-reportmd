...
いつも当イベントでは、コミュニティ外部の方々にも登壇していただいています。今回も第1部として[和田優斗 <i class="fas fa-external-link-alt"></i>](https://twitter.com/kyoto_ysfh)さん、[逢賀サク <i class="fas fa-external-link-alt"></i>](https://twitter.com/ogs_52843)さん、そして[Andreas Zettl <i class="fas fa-external-link-alt"></i>](https://twitter.com/andreas_zettl)さんから貴重な報告を聞くことができました。和田さんには[2020年度未踏事業として採択された](https://www.ipa.go.jp/jinzai/mitou/2020/gaiyou_sd-2.html)新組版システム「Twight」をご発表いただきました。逢賀さんには非エンジニアの立場から取っつきづらいVivliostyleの現状を鋭く批判していただきました。また、Andreas さんには世界の主要CSS組版エンジン全てをAPI化し、自在に切り替えてプレビューできるご自身のサービス、[PrintCSS Playground <i class="fas fa-external-link-alt"></i>](https://printcss.live/) と [PrintCSS Cloud <i class="fas fa-external-link-alt"></i>](https://printcss.cloud/) を紹介してもらいました。まさに当イベントでしか聞けない素晴らしい発表ばかりで、心から御礼申し上げます。
